...
internal static class MediaTypeUtil
{
    ...
    {
        return string.Equals(Normalize(contentType), "application/x-www-form-urlencoded",
            StringComparison.OrdinalIgnoreCase);
    }

    public static bool IsMultipartForm(string? contentType)
    {
        return Normalize(contentType)?.StartsWith("multipart/form-data", StringComparison.OrdinalIgnoreCase) == true;
    }
