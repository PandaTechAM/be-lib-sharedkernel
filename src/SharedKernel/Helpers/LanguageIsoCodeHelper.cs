...
public static class LanguageIsoCodeHelper
{
   ...
   public static bool IsValidLanguageCode(string isoCode) => AvailableLanguages.ContainsKey(isoCode);

   public static string? GetName(string isoCode) => AvailableLanguages.TryGetValue(isoCode, out var name) ? name : null;
